...
В рамках данной лабораторной работы вам предстоит поработать со статическими и динамическими массивами в языке C++. Задание находится в файле [tasks.md](./tasks.md). 
...
2. Решение задачи с использованием динамического массива (решение разместить в файле [lab3_dynamic.cpp](./lab3_dynamic.cpp)). **Номер варианта**: $(N + 1) \mod{13} + 1$, где $N$ – ваш порядковый номер в группе.
