...
В этой же директории в файле [task_lab1.md](./task_lab1.md) находятся задания к первой лабораторной работе. Задание 1 мы разобрали на занятии. Остальные задания вам нужно выполнить самостоятельно.
